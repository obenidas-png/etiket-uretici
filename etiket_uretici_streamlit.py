    ...
    for idx, row in df.iterrows():
        ...
        if 'cerasus' in store_name.lower():
            ...
            orders.append({'Mağaza': store_code, 'Sipariş No': row.get('SiparişNumarası', ''),
                ...
                'Özel Not': '', 'Durum': '', 'Etiket': str(row.get('_Label','') or ''), 'Ürün': product_clean})
        else:
            model = ''
            color = ''
            ...
            if 'set of 2' in product_lower or 'Size for Your Partner' in props:
                ...
                if size1:
                    ...
                    orders.append({'Mağaza': store_code, 'Sipariş No': row.get('SiparişNumarası', ''),
                        ...
                        'Özel Not': _ozel1, 'Durum': _durum1, 'Etiket': str(row.get('_Label','') or ''), 'Ürün': product})
                if size2:
                    ...
                    orders.append({'Mağaza': store_code, 'Sipariş No': row.get('SiparişNumarası', ''),
                        ...
                        'Özel Not': _ozel2, 'Durum': _durum2, 'Etiket': str(row.get('_Label','') or ''), 'Ürün': product})
            else:
                ...
                orders.append({'Mağaza': store_code, 'Sipariş No': row.get('SiparişNumarası', ''),
                    ...
                    'Özel Not': _ozel, 'Durum': _durum, 'Etiket': str(row.get('_Label','') or ''), 'Ürün': product})
